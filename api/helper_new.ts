  ...
  const functions = [
    {
      ...
      parameters: {
        ...
        properties: {
          roomId: {
            type: "integer",
            description: "roomId可以用来区分需要订座的店铺，其中roomId=37的店铺是南京江北新区店(又称江北店),roomId=40的店铺是张家港店,roomId=41的店铺是南京河西奥体店(又称河西店，奥体店),roomId=43的店铺是南京仙林中心店(又称仙林店),roomId=44的店铺是海拉尔海桥店(又称海桥店),roomId=45的店铺是海拉尔河东店,roomId=46的店铺是苏州狮山店(又称狮山店),roomId=49的店铺是杭州滨江店(又称滨江店),roomId=50的店铺是南京凤凰书城店(又称凤凰店,凤凰书城),roomId=51的店铺是镇江润州店,roomId=52的店铺是南京江宁店(又称江宁店),roomId=53的店铺是阿克苏店,roomId=89的店铺是仙林东南店(又称仙林店),roomId=97的店铺是江浦同心店(又称同心店),roomId=102的店铺是镇江万科店,roomId=116的店铺是扬州京华城店(又称京华城店),roomId=124的店铺是嵊州吾悦店,roomId=135的店铺是南京中和店(又称中和店),roomId=186的店铺是宁波大学店,roomId=201的店铺是南京南站店(又称喜马拉雅店,南站店)",
          },
          deskId: {
            type: "integer",
